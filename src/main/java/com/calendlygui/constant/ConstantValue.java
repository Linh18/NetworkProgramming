...
public class ConstantValue {
    ...
    public static final String HOST_ADDRESS = "192.168.50.160";
    ...
    public static final String SEARCH = "SEARCH_FOR_TEACHER_NAME";
    ...
    public static final int ACCOUNT_EXIST = 111;
    public static final int CLIENT_MISSING_INFO = 112;
    public static final int INCORRECT_FORMAT = 113;
    public static final int DUPLICATE_SCHEDULE = 201;
    public static final int UNDEFINED_ERROR = 202;
    public static final int QUERY_SUCCESS = 300;
    public static final int UPDATE_SUCCESS = 210;
